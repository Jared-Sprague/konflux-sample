...
/*# sourceMappingURL=cp-404.min.css.map */
  ...
  <div class="text-container">
    ...
    ${this.bounce&&new URLSearchParams(window.location.search).get("externalURL")!==null?`<p><span class="external-link">External link:</span> ${new URLSearchParams(window.location.search).get("externalURL")}</p>`:""}
    ${this.bounce?`
        <button class="back-button margin-right" onclick="(function navigate(e) { history.back() })()">Go back</button>
      `:""}
    ${this.bounce&&new URLSearchParams(window.location.search).get("externalURL")!==null?`<pfe-cta>
        <a
          href="${new URLSearchParams(window.location.search).get("externalURL")}">
          Proceed
        </a>
      </pfe-cta>`:""}
    ${this.bounce?"":`<pfe-cta>
...
<slot hidden></slot>`}static get properties(){return{}}static get slots(){return{default:{title:"Default slot",type:"array",namedSlot:!1,items:{oneOf:[{$ref:"raw"}]}}}}static get tag(){return"cp-404"}get schemaUrl(){return"cp-404.json"}get templateUrl(){return"cp-404.html"}get styleUrl(){return"cp-404.css"}static get PfeType(){return t.PfeTypes.Content}static get properties(){return{heading:{type:String},subheading:{type:String},errormessage:{type:String},bounce:{type:String}}}static get slots(){return{}}constructor(){super(e,{type:e.PfeType})}};t.create(e);var o=e;export{o as default};
/*! For license information please see cp-404-XXZSHFFB.js.LEGAL.txt */
//# sourceMappingURL=cp-404-XXZSHFFB.js.map
